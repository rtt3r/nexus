...
internal class UpdatePersonCommandValidator : AbstractValidator<UpdatePersonCommand>
{
    ...
    private class RegisterPersonAddressCommandValidator : AbstractValidator<UpdatePersonAddressCommand>
    {
    ...
    private class RegisterPersonEmailCommandValidator : AbstractValidator<UpdatePersonEmailCommand>
    {
    ...
    private class RegisterPersonPhoneNumberCommandValidator : AbstractValidator<UpdatePersonPhoneNumberCommand>
    {
