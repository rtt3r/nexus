...
namespace Nexus.Hcm.Application;

internal abstract class CommandHandler(IHcmUnitOfWork uow, IPublishEndpoint publishEndpoint, ITypeAdapter typeAdapter)
{
    protected readonly IHcmUnitOfWork uow = uow;
