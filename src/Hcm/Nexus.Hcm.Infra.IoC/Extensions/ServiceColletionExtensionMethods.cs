...
using Nexus.Hcm.Application.Extensions.DependencyInjection;
using Nexus.Hcm.Domain.Extensions.DependencyInjection;
using Nexus.Hcm.Infra.Data.Extensions.DependencyInjection;
using Nexus.Hcm.Infra.Data.Query.DependencyInjection;
...
public static class ServiceColletionExtensionMethods
{
    ...
    public static IServiceCollection AddAutoMapperTypeAdapter(this IServiceCollection services, Action<TypeAdapterOptions>? action = null)
    {
        ...
        services.AddAutoMapper([.. options.AutoMapperAssemblies, typeof(HcmApplicationOptions).Assembly]);
